...
export const ProjectDetails: React.FC<ProjectDetailsProps> = ({ expediente, onBack }) => {
  return (
    <div className="min-h-screen bg-[#07080d] flex flex-col text-white font-sans">
      {/* HEADER */}
      <header className="px-5 py-6 flex justify-between items-center bg-[#13141f]/80 backdrop-blur-md sticky top-0 z-50">
      ...
      {/* PROGRESO FOTOS */}
      <div className="px-6 py-4 flex justify-between items-center text-[11px] font-bold tracking-wider">
        <span className="text-gray-500 uppercase">Progreso Fotos</span>
        <span className="text-[#00ff88]">0%</span>
      </div>

      {/* LISTA DE RECINTOS */}
      <main className="flex-1 overflow-y-auto px-4 pb-10 space-y-4 custom-scrollbar">
